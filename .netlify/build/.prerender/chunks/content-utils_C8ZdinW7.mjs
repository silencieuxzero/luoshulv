import { j as AstroError, I as InvalidComponentArgs, k as renderElement, l as generateCspDigest, n as spreadAttributes, u as unescapeHTML, r as renderTemplate, p as removeBase, q as isRemotePath, L as LiveContentConfigError, A as AstroUserError, t as unflatten, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, v as escape, o as object, f as date, e as array, s as string, w as prependForwardSlash, x as createHeadAndContent, a as renderComponent } from './prerender_Bwfl1wrL.mjs';
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_C_BiedXz.mjs');
